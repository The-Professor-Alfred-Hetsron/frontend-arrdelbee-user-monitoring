...
import { CustomDateInput, CustomDropDown, InputField } from "..";
...
const PaymentCardForm: React.FC<PaymentMethodProps> = ({ preferedPaiementMethod, onClose, name, number, cvv, expiredDate, userProfileData }) => {
    const [apiUserProfile, setApiUserProfile] = useState<UserProfile>({...userProfileData});
            ...
            <div className="flex flex-col items-center p-[10px] gap-[15px] w-[375px] ">
                <div className="flex flex-row items-center justify-center gap-[10px]">
                    { displayUserProfile.preferedMobilePayment === "Mobile Money" ?
                        <Image src="/assets/img/paymentMethods/mtn-momo.png" alt="Mobile Money icon" height={200} width={200} className="w-[50px] h-[35px] rounded-[8px]"/>
                        :
                        <Image src="/assets/img/paymentMethods/orange-money.png" alt="Orange Money icon" height={200} width={200} className="w-[50px] h-[35px] rounded-[8px]"/>
                    }
                    <CustomDropDown
        ...
        <div className="flex flex-row items-center p-[15px] gap-[10px] w-full bg-[#FFFFFF] rounded-[20px]">
            ...
            <div className="flex flex-col items-center  gap-[15px] w-[375px]">
                <div className="flex flex-row items-center justify-center gap-[10px]">
                    ...
                    <CustomDropDown
                        placeholder="Choisissez votre methode de paiement bancaire"
